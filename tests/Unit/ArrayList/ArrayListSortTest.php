...
class ArrayListSortTest extends TestCase
{
    #[Test] public function given_an_array_list_then_sort_without_comparing_callback(): void
    {
        ...
        $this->assertEquals(new ArrayList([new Bar("4"), new Bar("2"), new Bar("1"), new Bar("3")]), $list);
        $this->assertEquals(new ArrayList([new Bar("1"), new Bar("2"), new Bar("3"), new Bar("4")]), $sorted);
    }
    ...
    #[Test] public function given_an_array_list_then_sort_with_comparing_callback(): void
    {
        ...
        $this->assertEquals(new ArrayList([new Bar("44"), new Bar("26"), new Bar("17"), new Bar("35")]), $list);
        $this->assertEquals(new ArrayList([new Bar("44"), new Bar("35"), new Bar("26"), new Bar("17")]), $sorted);
    }
}
